...
const AddPlantPage = () => {
    ...
    const [choosedOfficeId, setChoosedOfficeId] = useState<number>(curOfficeId ? curOfficeId : 2);
    ...
    const getFertilisers = (): FertiliserCreateDTO[] => {
        return choosedFertilisers.map(fertiliserId =>
            ({fertiliserQuantity: 100, periodOfFertilising: 100, id: fertiliserId})
        )
    }
            ...
            <Form classes={styles.form} onSubmit={sendInfo}>
                ...
                <div className={styles.fertilisers_wrapper}>
                    ...
                    <div
                        ...
                        onClick={() => addFertiliser(fertiliserSelects.length)}>ADD</div>
                </div>
